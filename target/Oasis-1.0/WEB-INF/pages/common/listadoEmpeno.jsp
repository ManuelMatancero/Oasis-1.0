    ...
    <div class="container">   
        <div class="row">
            ...
            <c:forEach var="empeno" items="${empenos}">
                            ...
                            <c:if test="<%= estado.equalsIgnoreCase("Vencido")%>">
                                <div class="card-header bg-danger">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"> 
                                            <a href="${pageContext.request.contextPath}/ServletControladorAbono?idEmpeno=${empeno.idEmpeno}" class="btn btn-secondary btn-sm shadow">
                                            ...
                                            <a href="#" class="btn btn-info btn-sm shadow">
                                                ...
                                                Editar</a>
                                            <a href="#" class="btn btn-control btn-sm" data-toggle="tooltip" data-placement="top" title="Cancelar Prestamo">
                            ...
                            <c:if test="<%= estado.equalsIgnoreCase("Activo")%>">
                                <div class="card-header bg-success">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"> 
                                            <a href="${pageContext.request.contextPath}/ServletControladorAbono?alerta=nula&idEmpeno=${empeno.idEmpeno}" class="btn btn-secondary btn-sm shadow">
                                                <i class="fa-solid fa-receipt"></i>
                                                Historial
                                            </a>
                                            <a href="#" class="btn btn-info btn-sm shadow">
                                ...
                                <div class="btn-group dropup">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li> <a class="dropdown-item" href="#"
                                                data-bs-toggle="modal" data-bs-target="#abonoInteresModal<%=contador%>">Abono interes</a></li>
                                        <li> <a class="dropdown-item" href="#"
                                                data-bs-toggle="modal" data-bs-target="#abonoCapitalModal<%=contador%>">Abono capital</a></li>
                                    </ul>
                                </div>
                ...
                <div class="modal fade" id="abonoCapitalModal<%=contador%>">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="${pageContext.request.contextPath}/ServletControladorAbono?accion=abonarCapital&idAbono=${abono.idAbono}&idEmpeno=${empeno.idEmpeno}&idCliente=${idCliente}&alerta=pagoagregado"
                                      method="POST" class="was-validated" >
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="interesGenerado">Interes total: </label>
                                                <input class="form-control" id="interesGenerado" type="text" value="${empeno.interesEmpeno}" name="interesGenerado">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="capital" onkeyup="sumar()" type="text" placeholder="$0.00" name="capital">
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col">
                                            <h3 class="fs-4">Total:</h3> <h3 id="total">${empeno.interesEmpeno}</h3> 
                                        </div>
                                    </div>
                                </form>
                            </div>
